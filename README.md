...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9ppl29e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9ppl29e.containers.anotherwebservice.com/
...
```
git clone git@github.com:sir-argupta/container-9ppl29e.git
cd container-9ppl29e
```
...
```
docker attach container-9ppl29e
```
